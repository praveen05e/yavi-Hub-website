...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const els = [line1Ref, line2Ref, subRef, ctaRef, scrollRef].map((r) => r.current);
    ...
    tl.set(imgRef.current, { scale: 1.08 })
      ...
      .fromTo(line1Ref.current, { opacity: 0, y: 24 }, { opacity: 1, y: 0, duration: 0.7 }, 0.5)
      .fromTo(line2Ref.current, { opacity: 0, y: 24 }, { opacity: 1, y: 0, duration: 0.65 }, 0.65)
      .fromTo(subRef.current, { opacity: 0, y: 16 }, { opacity: 1, y: 0, duration: 0.6 }, 0.85)
  ...
  return (
    <section className="relative flex min-h-screen items-center md:items-end overflow-hidden bg-charcoal">
      ...
      <div className="relative z-20 mx-auto w-full max-w-7xl px-6 pt-24 pb-20 md:pt-0 lg:px-10 lg:pb-28">
        ...
        <p ref={subRef} className="mt-6 max-w-md text-base text-white lg:text-lg">
